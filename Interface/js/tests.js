function TestBoardMove()
{
  ...
  board.pieces[2].Move(Region.Cologne)
  board.pieces[3].Move(Region.Hamburg)
  board.pieces[4].Move(Region.Holland)
  board.pieces[5].Move(Region.Bordeaux)
  board.pieces[6].Move(Region.Paris)
  board.pieces[7].Move(Region.Hamburg)
}
